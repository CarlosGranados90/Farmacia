...
public class LoginView extends javax.swing.JFrame {
    ...
    public LoginView() {
        initComponents();
        setSize(930, 415); // ajusar tamaño
        setResizable(false); // redimensionar interfaz
        setTitle("Ingresar al sistema"); // titulo
        setLocationRelativeTo(null); // usuario no puede mover ventana
